...
async function GET() {
    const devices = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].listDevices();
...
async function POST(req) {
    ...
    const { name, equipmentType, hospitalId, model } = body || {};
    if (!name || !equipmentType || !hospitalId) return Response.json({
        error: 'name, equipmentType, hospitalId required'
    }, {
        status: 400
    });
    const d = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].addDevice({
        name,
        equipmentType,
        hospitalId,
        model
...
async function DELETE(req) {
    ...
    const ok = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["store"].removeDevice(id);
    return Response.json({
        ok
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8d5887c4._.js.map