...
async function GET(req) {
    ...
    const payload = await Promise.all(list.map(async (d)=>({
            device: d,
            telemetry: await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$telemetry$2d$source$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTelemetryPoints"])(d.id, 50)
        })));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3d31d18._.js.map