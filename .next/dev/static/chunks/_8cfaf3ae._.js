    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsPage.useEffect": ()=>{
            fetch('/api/branding').then({
                ...
                "SettingsPage.useEffect": (j)=>setLogoUrl(j.branding?.logoUrl || '')
            }["SettingsPage.useEffect"]);
            fetch('/api/profile').then({
                "SettingsPage.useEffect": (r)=>r.json()
            }["SettingsPage.useEffect"]).then({
                "SettingsPage.useEffect": (j)=>setAvatarUrl(j.profile?.avatarUrl || '')
            }["SettingsPage.useEffect"]);
        }
    }["SettingsPage.useEffect"], []);
...
_s(SettingsPage, "IPxrPzLcB101pHRCEoXkKSq9Hdc=");
_c = SettingsPage;
var _c;
...
//# sourceMappingURL=_8cfaf3ae._.js.map