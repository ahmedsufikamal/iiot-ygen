...
function StatusBadge({ status }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        className: "badge",
        style: {
            ...Object.fromEntries(color[status].split(';').filter(Boolean).map((s)=>s.trim().split(': ')))
        },
        children: [
...
function Sparkline({ data, width = 220, height = 60 }) {
    ...
    const d = data.map((p, i)=>`${i ? 'L' : 'M'}${scaleX(p.ts).toFixed(1)},${scaleY(p.v).toFixed(1)}`).join(' ');
...
//# sourceMappingURL=_7b4dde6e._.js.map