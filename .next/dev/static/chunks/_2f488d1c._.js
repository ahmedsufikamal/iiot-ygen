...
async function fetchDevices(qs) {
...
function DashboardPage() {
    ...
    const [division, setDivision] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [upazila, setUpazila] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [hospital, setHospital] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            fetch('/api/meta', {
                ...
                "DashboardPage.useEffect": (j)=>setAll((j.devices || []).map({
    ...
    const load = async ()=>{
        ...
        try {
            ...
            setItems(await fetchDevices(`?${params.toString()}`));
        } finally{
            setLoading(false);
        }
    };
    ...
    const divisions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[divisions]": ()=>uniq(all.map({
                "DashboardPage.useMemo[divisions]": (d)=>d.device.division
            }["DashboardPage.useMemo[divisions]"]).filter(Boolean))
    }["DashboardPage.useMemo[divisions]"], [
        all
    ]);
    const districts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[districts]": ()=>uniq(all.filter({
                "DashboardPage.useMemo[districts]": (d)=>!division || d.device.division === division
            }["DashboardPage.useMemo[districts]"]).map({
                "DashboardPage.useMemo[districts]": (d)=>d.device.district
            }["DashboardPage.useMemo[districts]"]).filter(Boolean))
    }["DashboardPage.useMemo[districts]"], [
        all,
        division
    ]);
    const upazilas = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[upazilas]": ()=>uniq(all.filter({
                "DashboardPage.useMemo[upazilas]": (d)=>(!division || d.device.division === division) && (!district || d.device.district === district)
            }["DashboardPage.useMemo[upazilas]"]).map({
                "DashboardPage.useMemo[upazilas]": (d)=>d.device.upazila
            }["DashboardPage.useMemo[upazilas]"]).filter(Boolean))
    }["DashboardPage.useMemo[upazilas]"], [
        all,
        division,
        district
    ]);
    const hospitals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[hospitals]": ()=>uniq(all.filter({
                "DashboardPage.useMemo[hospitals]": (d)=>(!division || d.device.division === division) && (!district || d.device.district === district) && (!upazila || d.device.upazila === upazila)
            }["DashboardPage.useMemo[hospitals]"]).map({
                "DashboardPage.useMemo[hospitals]": (d)=>d.device.hospitalName
            }["DashboardPage.useMemo[hospitals]"]).filter(Boolean))
    }["DashboardPage.useMemo[hospitals]"], [
        all,
        division,
        district,
        upazila
    ]);
    const equipments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[equipments]": ()=>uniq(all.map({
                "DashboardPage.useMemo[equipments]": (d)=>d.device.equipmentType
            }["DashboardPage.useMemo[equipments]"]).filter(Boolean))
    }["DashboardPage.useMemo[equipments]"], [
        all
    ]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "grid",
                ...
                children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: [
                                    ...
                                    divisions.map((d)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: d,
                                            children: d
                                        }, d, false, {
                                            fileName: "[project]/app/(shell)/dashboard/page.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: [
                                    ...
                                    upazilas.map((u)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: u,
                                            children: u
                                        }, u, false, {
                                            fileName: "[project]/app/(shell)/dashboard/page.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: [
                                    ...
                                    equipments.map((eq)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: eq,
                                            children: eq
                                        }, eq, false, {
                                            fileName: "[project]/app/(shell)/dashboard/page.tsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: '/devices?status=MAINTENANCE',
                                className: "card",
                                style: {
                                    display: 'block'
                                },
...
_s(DashboardPage, "ClYdX+iNSigrf+ubRFBDQMhR6lE=");
_c = DashboardPage;
var _c;
...
//# sourceMappingURL=_2f488d1c._.js.map